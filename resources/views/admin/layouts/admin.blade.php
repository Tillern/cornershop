...
<html lang="en">
    ...
    <head>
        ...
        <!-- Required Fremwork -->
        <link rel="stylesheet" type="text/css" href="href="{{ asset('assets/css/bootstrap/css/bootstrap.min.css') }}">
        <!-- waves.css -->
                                        ...
                                        <li class="waves-effect waves-light">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="notification-msg">Easy management</p>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome to CornerShop</p>
                                        </div>
                                    </div>
                                    <div class="col-4">
