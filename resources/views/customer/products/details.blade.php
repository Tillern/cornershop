...
<html lang="zxx" class="no-js">
   ...
   ============================================= -->
        ...
        <link rel="stylesheet" href="{{ asset('customerassets/css/ion.rangeSlider.css') }}">
        <link rel="stylesheet" href="{{ asset('customerassets/css/ion.rangeSlider.skinFlat.css') }}">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item submenu dropdown active">
                                    <a href="{{ route('customer.shop') }}" class="nav-link dropdown-toggle"
                ...
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        ...
                        <nav class="d-flex align-items-center">
                            ...
                            <a href="{{ route('customer.shop') }}">Shop<span class="lnr lnr-arrow-right"></span></a>
                        ...
                        <div class="s_product_text">
                            ...
                            <ul class="list">
                                ...
                                <li><a href="#"><span>Availibility</span> :
                                        {{ $product->stock > 0 ? $product->stock : 'Out of Stock' }} In Stock</a></li>
                            ...
                            <div class="card_area d-flex align-items-center">
                                ...
                                {{-- <a class="primary-btn" id="add-to-cart" href="#">Add to Cart</a> --}}
                            ...
                            <div class="col-lg-6">
                                <div class="comment_list">
                                    <div class="review_item">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="{{ asset('customerassets/img/product/review-1.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Braison Minodi</h4>
                                    ...
                                    <div class="review_item reply">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="{{ asset('customerassets/img/product/review-2.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Braison Minodi</h4>
                                    ...
                                    <div class="review_item">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="{{ asset('customerassets/img/product/review-3.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Braison Minodi</h4>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mb-20">
                                <div class="single-related-product d-flex">
                                    <a href="#"><img src="{{ asset('customerassets/img/r4.jpg') }}"
                                            alt=""></a>
                                    <div class="desc">
                                        <a href="#" class="title">Black lace Heels</a>
                                        <div class="price">
                    ...
                    form.addEventListener('submit', function(event) {
                        ...
                        fetch(this.action, {
                            ...
                            .then(data => {
                                ...
                                // Optionally update cart UI or item count
                            })
                            .catch(error => {
