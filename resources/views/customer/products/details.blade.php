					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								<a href="{{ route('customer.shop') }}" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> :{{ $product->category->name ?? 'Uncategorized' }}</a></li>
							<li><a href="#"><span>Availibility</span> :  {{ $product->stock > 0 ? $product->stock : 'Out of Stock' }} In Stock</a></li>
